...
sections = ["Home","Educational Content Finder", "Meeting Reminder", "Lecture Enhancement", "Automated Feedback System", "Language Learning Companion", "AI-BOT","Lets Try Quizzz","Automated Assignment Generator"]
